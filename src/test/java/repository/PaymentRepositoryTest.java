...
class PaymentRepositoryTest {
    ...
    void setUp() {
        ...
        Payment payment1 = new Payment(UUID.fromString("13652556-012a-4c07-b546-54eb1396d79b"), "VOUCHER", paymentData1);
        payments.add(payment1);

        Map<String, String> paymentData2 = new HashMap<>();
        paymentData2.put("voucherCode", "ESHOP1234ABC5679");
        Payment payment2 = new Payment(UUID.fromString("7f9e15bb-4b15-42f4-aebc-c3af385fb078"), "VOUCHER", paymentData2);
